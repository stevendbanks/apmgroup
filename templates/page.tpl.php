...
<body>
	...
	<?
		...
		if(isset($node->content["field_bg_image"]["field"]["items"][0]["#node"]->field_bg_image[0]["filepath"]))
		{
			...
			$def = strpos($apm_bg_img, "BowerPlace-5848.jpg");
			if($def > 0)
			{	$apm_bg_img = "";
			}
		}
		else
		{
			...
			// Client List image only appears on the Client List View Page
			if(arg(1) == "apm-clients")
			{
				$apm_bg_img = "sites/all/themes/apmgroup/images/clientlist.png";
			}
			
			// If it's a Project Content type page then don't display if not set
			if(arg(1) == "project")
			{
				$apm_bg_img = "";
			}
                ...
                //  SDBANKS 2012-10-11 -  There should not be a header displayed for News Detail Pages
		if ( node_get_types('name',$node) == "News")
                { $apm_bg_img = "";
                }
                

                //  SDBANKS 2012-10-19 -  There should not be a header displayed for Staff Member Detail Pages
		if ( node_get_types('name',$node) == "Staff_Member")
                { $apm_bg_img = "";
                }
	...
	<!-- <div id="site_wrapper">  -->
		<div id="body_wrapper" class="container_24">
			...
			<div class="grid_24 slider-wrapper theme-default">
				...
				<div id="apm_breadcrumb" class="grid_24"><div><?php print $breadcrumb; ?></div></div> <!-- <div id="apm_full_name">APM Construction Services</div> -->
				<div class="clear"></div>
				<div id="apm_text" class="grid_16 columns">
				...
				<div id="sidebar_right_wrapper" class="grid_8 columns"> 
		  			<div id="sidebar_right" style="padding:10px;">
		  				...
		  				<div style="padding:5px"><?php print $sidebar_right; ?></div>
		  			</div>
		  		</div>
		  		<div class="clear"></div>
